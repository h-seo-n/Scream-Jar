...
"}"));
        ...
        label_5->setStyleSheet(QString::fromUtf8("font: 11pt \"Ariel\";"));
        ...
        verticalSpacer_2 = new QSpacerItem(20, 50, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::MinimumExpanding);
...
"Whether it be because of studies, work, relationship, or politics and society, just vent it to your scream jar. \n"
" (Due to the cheap server, sometimes app initialization takes around 1 minute.\n"
"please wait if the app doesn't start!)\n"
"\n"
"*Feedback & Error : best3487@snu.ac.kr", nullptr));
    } // retranslateUi
