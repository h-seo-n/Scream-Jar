...
Q_CONSTINIT static const uint qt_meta_data_CLASSLoginWidgetENDCLASS[] = {
 ...
 // slots: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       5,    1,   58,    2, 0x28,    7 /* Private | MethodCloned */,
...
Q_CONSTINIT const QMetaObject LoginWidget::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSLoginWidgetENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'showLoginfailMessage'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'showTemporaryMessage'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void LoginWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->showLoginfailMessage(); break;
        case 3: _t->showTemporaryMessage((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        case 4: _t->showTemporaryMessage((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &LoginWidget::goToSignup; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
