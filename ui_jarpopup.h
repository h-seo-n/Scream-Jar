...
public:
    ...
    void setupUi(QDialog *jarPopup)
    {
        ...
        label->setFont(font);
        label->setStyleSheet(QString::fromUtf8("font: 700 12pt \"\353\247\221\354\235\200 \352\263\240\353\224\225\";"));

        verticalLayout_2->addWidget(label, 0, Qt::AlignmentFlag::AlignLeft);

        label_2 = new QLabel(jarPopup);
        label_2->setObjectName("label_2");

        verticalLayout_2->addWidget(label_2, 0, Qt::AlignmentFlag::AlignLeft);
    ...
    void retranslateUi(QDialog *jarPopup)
    {
        ...
        label_2->setText(QCoreApplication::translate("jarPopup", "click on the rightmost column to sort by date!", nullptr));
    } // retranslateUi
