...
public:
    ...
    void setupUi(QWidget *friendAddPopup)
    {
        ...
        friendAddPopup->resize(338, 293);
        QSizePolicy sizePolicy(QSizePolicy::Policy::Preferred, QSizePolicy::Policy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(friendAddPopup->sizePolicy().hasHeightForWidth());
        friendAddPopup->setSizePolicy(sizePolicy);
        ...
        sizePolicy2.setHeightForWidth(idInput->sizePolicy().hasHeightForWidth());
        idInput->setSizePolicy(sizePolicy2);
        ...
        sizePolicy1.setHeightForWidth(idLabel2->sizePolicy().hasHeightForWidth());
        idLabel2->setSizePolicy(sizePolicy1);
        ...
        sizePolicy3.setHeightForWidth(friendIDLabel->sizePolicy().hasHeightForWidth());
        friendIDLabel->setSizePolicy(sizePolicy3);
        ...
        sizePolicy4.setHeightForWidth(friendUsernameLabel->sizePolicy().hasHeightForWidth());
        friendUsernameLabel->setSizePolicy(sizePolicy4);
        ...
        verticalLayout_2->addWidget(confirmWidget);
